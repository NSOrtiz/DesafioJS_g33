...
// Función para ordenar los posts por rating de mayor a menor
const sortByRating = (postArray) => {
    return postArray.sort((a, b) => b.reactions - a.reactions);
}
...
const printCardsAsync = async () => {
    ...
    postArray = sortByRating(postArray); // Ordenar los posts por rating
