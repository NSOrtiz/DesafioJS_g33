...
const getData = async () => {
    ...
    // Funcion Top
    postArray = postArray.filter(post => post.rating > 7)
...
let createCard = (postArray) => {
    let { name, avatar, date, title, reactionsNumber, timeAgo } = postArray
    ...
    let tagProductivitytext = document.createTextNode(`#`)
    ...
    imgIcons1.setAttribute('heigth', '24')
    ...
    imgIcons2.setAttribute('heigth', '24')
    ...
    imgIcons3.setAttribute('heigth', '24')
    ...
    imgIcons4.setAttribute('heigth', '24')
    ...
    svg.append(path)
    save.append(svg)
    tagSpan.append(tagName)
    
    tagProductivity.append(tagSpan)
